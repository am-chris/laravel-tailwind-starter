...
var render = function() {
  ...
  return _c("img", {
    staticClass: "inline-block mr-3 h-6 w-6 rounded",
    attrs: {
      src:
        "https://images.unsplash.com/photo-1517365830460-955ce3ccd263?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=128&q=100"
    }
  })
}
var staticRenderFns = []
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { class: _vm.inline == true ? "inline" : "block" }, [
    _vm.visible
      ? _c("button", {
          staticClass:
            "w-full h-full top-0 right-0 left-0 bottom-0 absolute z-10 block",
          attrs: { type: "button" },
          on: {
    ...
    _c(
      "button",
      {
        staticClass: "relative px-1 z-30",
        on: {
          click: function($event) {
    ...
    _vm.visible == true
      ? _c(
          ...
          {
            staticClass:
              "right-0 mr-3 bg-white text-gray-400 list-none absolute w-32 text-left shadow-lg rounded mt-1 p-0 rounded hover:rounded z-20"
          },
...
__webpack_require__(/*! /Users/christopherlandon/sites/TailKit/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/christopherlandon/sites/TailKit/resources/css/app.css */"./resources/css/app.css");
